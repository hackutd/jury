...
pub fn update(alpha: f64, beta: f64, mu_winner: f64, sigma_sq_winner: f64, mu_loser: f64, sigma_sq_loser: f64) -> (f64, f64, f64, f64, f64, f64) {
    let (updated_alpha, updated_beta, _) = update_annotator(alpha, beta, mu_winner, sigma_sq_winner, mu_loser, sigma_sq_loser);
    let (updated_mu_winner, updated_mu_loser) = update_mus(alpha, beta, mu_winner, sigma_sq_winner, mu_loser, sigma_sq_loser);
    let (updated_sigma_sq_winner, updated_sigma_sq_loser) = update_sigma_sqs(alpha, beta, mu_winner, sigma_sq_winner, mu_loser, sigma_sq_loser);
    return (updated_alpha, updated_beta, updated_mu_winner, updated_sigma_sq_winner, updated_mu_loser, updated_sigma_sq_loser);
}

pub fn expected_information_gain(alpha: f64, beta: f64, mu_a: f64, sigma_sq_a: f64, mu_b: f64, sigma_sq_b: f64) -> f64 {
    ...
    let (sigma_sq_a1, sigma_sq_b1) = update_sigma_sqs(alpha, beta, mu_a, sigma_sq_a, mu_b, sigma_sq_b);
    ...
    let (sigma_sq_a2, sigma_sq_b2) = update_sigma_sqs(alpha, beta, mu_b, sigma_sq_b, mu_a, sigma_sq_a);
...
fn update_annotator(alpha: f64, beta: f64, mu_winner: f64, sigma_sq_winner: f64, mu_loser: f64, sigma_sq_loser: f64) -> (f64, f64, f64) {
    let e_mu_winner = f64::exp(mu_winner);
    let e_mu_loser  = f64::exp(mu_loser);
    let c1 = e_mu_winner / (e_mu_winner + e_mu_loser) +
        0.5 * (sigma_sq_winner + sigma_sq_loser) *
    ...
    let expected_sq = (c1 * (alpha + 2.0) * (alpha + 1.0) * alpha + c2 * (alpha + 1.0) * alpha * beta) /
...
fn update_mus(alpha: f64, beta: f64, mu_winner: f64, sigma_sq_winner: f64, mu_loser: f64, sigma_sq_loser: f64) -> (f64, f64) {
    let e_mu_winner = f64::exp(mu_winner);
    let e_mu_loser  = f64::exp(mu_loser);
...
fn update_sigma_sqs(alpha: f64, beta: f64, mu_winner: f64, sigma_sq_winner: f64, mu_loser: f64, sigma_sq_loser: f64) -> (f64, f64) {
    let e_mu_winner = f64::exp(mu_winner);
    let e_mu_loser  = f64::exp(mu_loser);
